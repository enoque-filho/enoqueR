...
tabset_info = function(dados){
  ...
  cat("### Geral\n\n")
  print(geral(dados) %>% kbl() %>% kable_styling())

  cat("### Estrutura\n\n")
  print(estrutura(dados) %>% kbl() %>% kable_styling())

  cat("### Resumo numéricas\n\n")
  print(resumo(dados) %>% kbl() %>% kable_styling())

  cat("### Resumo categóricas\n\n")
  print(resumo_cat(dados) %>% kbl() %>% kable_styling())
  cat("\n\n")
}
